...
function initMap() {
  ...
  controlLayers.addBaseLayer(Imagery, 'Imagery');
  controlLayers.addBaseLayer(Topographic, 'Topographic');
  controlLayers.addBaseLayer(Streets, 'Streets');
  // controlLayers.addBaseLayer(NationalGeographic, 'NationalGeographic');
